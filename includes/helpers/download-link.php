...
use BuddyClients\Includes\{
     ...
     *                                      Defaults to false.
     */
    function buddyc_download_links( $file_ids, $show_file_name = false ) {
        if ( ! empty( $file_ids ) ) {
     ...
     *                                      Defaults to false.
     */
    function buddyc_file_names( $file_ids, $comma_separated = false ) {
        if ( empty( $file_ids ) ) {
            return '';
        }
        ...
        foreach ( (array) $file_ids as $file_id ) {
            $icon = $comma_separated ? '' : buddyc_icon( 'paperclip' ) . ' ';
