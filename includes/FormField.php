...
class FormField {
    ...
    private function tinymce_field() {
        ...
        $editor_settings = array(
            ...
            'quicktags' => false,
            'tinymce' => array(
                'toolbar1' => __( 'bold italic underline | undo redo', 'buddyclients-lite' ), // Customize the buttons in the first row
    ...
    private function upload_field() {
        ...
        $field .=           '<button class="dz-button buddyc-file-upload-button" type="button"><strong>' . __( 'Select File', 'buddyclients-lite' ) . '</strong></button>';
        $field .=       '</div>';
        $field .=   '</div>';
    ...
    private function signature_field() {
        ...
        $field .= '<legend>' . __( 'Sign Here', 'buddyclients-lite' ) . '</legend>';
        $field .= '<canvas class="buddyc-signature-canvas" width="600" height="200" data-signature="signature-data"></canvas><br>';
        $field .= '<button type="button" class="buddyc-signature-clear-button">' . __( 'Clear Signature', 'buddyclients-lite' ) . '</button>';
