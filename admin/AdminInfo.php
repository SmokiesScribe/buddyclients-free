...
class AdminInfo {
    ...
    private static function messages() {
        return [            
            ...
            'overview'              => __( 'Evaluate your business with this overview of all bookings for a specified timeframe.<p>The net fee represents the total fees minus team member payments, affiliate commission, and sales commission.</p>', 'buddyclients-free' ),
            'payments'              => sprintf(
            ...
            // Settings
            'settings'              => __( 'General settings for the BuddyClients plugin.<p><i>Remove these messages by changing the "Admin Info Messages" setting below to "disable."</i>', 'buddyclients-free' ),
            ...
            'pages'                 => __( 'Select or create the pages used by the BuddyClients plugin.<p>Clicking the "Create Page" button will automatically insert the shortcode into the page.</p><p>If you create the pages manually, be sure to add each specified shortcode.</p>', 'buddyclients-free' ),
            'styles'                => __( 'Adjust the plugin styles to match your brand.', 'buddyclients-free' ),
            'bookings'              => __( 'Update these settings to change the way BuddyClients manages bookings.<p>If you are the only member of your team, enabling Freelancer Mode simplifies the BuddyClients interface and assigns all services to you.</p>', 'buddyclients-free' ),
            ...
            // Emails
            'email templates'       => __( 'Customize the BuddyClients plugin emails using these templates. Dynamic values are enclosed in double brackets, e.g. {{site_name}}.<p>To restore default email templates, delete the templates you wish to restore and click "Repair Email Templates."</p>', 'buddyclients-free' ),
            'email log'             => __( 'This page lists all emails sent by the BuddyClients plugin during the timeframe specified in the plugin settings.', 'buddyclients-free' ),
            ...
            'import files'          => __( 'Import files in bulk by selecting a CSV file with your data.<p>Ensure the CSV file is formatted correctly and contains the appropriate fields.</p>', 'buddyclients-free' ),
            
            // Misc
            'misc'                  => __( 'Manage various settings for the BuddyClients plugin that do not fall into other categories.<p>Ensure that all necessary configurations are made to ensure the proper functionality of the plugin.', 'buddyclients-free' )
        ];
    }
