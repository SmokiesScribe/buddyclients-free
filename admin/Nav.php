...
class Nav {
    ...
    private static function tabs() {
        ...
        $tabs = [
            'dashboard' => [
                __( 'All Bookings', 'buddyclients-lite' )        => ['page'  => 'buddyc-dashboard'],
                'booked_services'                           => ['page'  => 'buddyc-booked-services'],
                __( 'Overview', 'buddyclients-lite' )            => ['page'  => 'buddyc-bookings-dashboard'],
                __( 'Client Payments', 'buddyclients-lite' )     => ['page'  => 'buddyc-booking-payments'],
                __( 'Outgoing Payments', 'buddyclients-lite' )   => ['page'  => 'buddyc-payments'],
                __( 'Users', 'buddyclients-lite' )               => ['page'  => 'buddyc-users'],
                __( 'Leads', 'buddyclients-lite' )               => ['page'  => 'buddyc-leads'],
            ],
            'legal' => [
                __( 'User Agreements', 'buddyclients-lite' )    => ['page'  => 'buddyc-user-agreements'],
                __( 'Legal Agreements', 'buddyclients-lite' )   => ['page'  => 'buddyc-legal-agreements'],
                __( 'Legal Modifications', 'buddyclients-lite' )=> ['post_type'  => 'buddyc_legal_mod'],
                __( 'Settings', 'buddyclients-lite' )           => ['page'  => 'buddyc-legal-settings', 'post_type'  => 'buddyc_legal'],
            ], 
            'settings' => [
                __( 'General', 'buddyclients-lite' )            => ['page'  => 'buddyc-general-settings'],
                __( 'Components', 'buddyclients-lite' )          => ['page'  => 'buddyc-components-settings'],
                __( 'Pages', 'buddyclients-lite' )               => ['page'  => 'buddyc-pages-settings'],
                __( 'Bookings', 'buddyclients-lite' )            => ['page'  => 'buddyc-booking-settings'],
                'Stripe'                                    => ['page'  => 'buddyc-stripe-settings'],
                __( 'Sales', 'buddyclients-lite' )               => ['page'  => 'buddyc-sales-settings'],
                __( 'Emails', 'buddyclients-lite' )              => ['page'  => 'buddyc-email-settings'],
                __( 'Legal', 'buddyclients-lite' )               => ['page'  => 'buddyc-legal-settings', 'post_type'  => 'buddyc_legal'],
                __( 'Affiliate', 'buddyclients-lite' )           => ['page'  => 'buddyc-affiliate-settings'],
                __( 'Contact', 'buddyclients-lite' )             => ['page'  => 'buddyc-help-settings'],
                __( 'Integrations', 'buddyclients-lite' )        => ['page'  => 'buddyc-integrations-settings'],
            ],
            'services' => [
                __( 'Services', 'buddyclients-lite' )            => ['post_type'  => 'buddyc_service'],
                __( 'Service Types', 'buddyclients-lite' )       => ['post_type'  => 'buddyc_service_type'],
                __( 'Rate Types', 'buddyclients-lite' )          => ['post_type'  => 'buddyc_rate_type'],
                __( 'Team Roles', 'buddyclients-lite' )          => ['post_type'  => 'buddyc_role'],
                __( 'Adjustment Fields', 'buddyclients-lite' )   => ['post_type'  => 'buddyc_adjustment'],
                __( 'Filter Fields', 'buddyclients-lite' )       => ['post_type'  => 'buddyc_filter'],
                __( 'File Upload Types', 'buddyclients-lite' )   => ['post_type'  => 'buddyc_file_upload'],
            ],
            'payments' => [
                __( 'Team Payments', 'buddyclients-lite' )       => ['page'  => 'buddyc-team-payments'],
                __( 'Affiliate Payments', 'buddyclients-lite' )  => ['page'  => 'buddyc-affiliate-payments'],
                __( 'Sales Payments', 'buddyclients-lite' )      => ['page'  => 'buddyc-sales-payments'],
            ],
            'briefs' => [
                __( 'Briefs', 'buddyclients-lite' )              => ['post_type'  => 'buddyc_brief'],
                __( 'Brief Types', 'buddyclients-lite' )         => ['taxonomy'   => 'brief_type', 'post_type'  => 'buddyc_brief'],
                __( 'Brief Fields', 'buddyclients-lite' )        => ['post_type'  => 'buddyc_brief_field'],
            ],
            'emails' => [
                __( 'Email Templates', 'buddyclients-lite' )    => ['post_type'  => 'buddyc_email'],
                __( 'Email Log', 'buddyclients-lite' )          => ['page'  => 'buddyc-email-log'],
            ],
            'users' => [
                __( 'Team', 'buddyclients-lite' )                => ['page'  => 'buddyc-team'],
                __( 'Affiliates', 'buddyclients-lite' )          => ['page'  => 'buddyc-affiliates'],
            ],
            'testimonials' => [
                __( 'Testimonials', 'buddyclients-lite' )       => ['post_type'  => 'buddyc_testimonial'],
            ],  
            'custom_quotes' => [
                __( 'Custom Quotes', 'buddyclients-lite' )      => ['post_type'  => 'buddyc_quote'],
            ],
            'license' => [
                __( 'License Key', 'buddyclients-lite' )        => ['page'  => 'buddyc-license-settings'],
            ]
        ];
