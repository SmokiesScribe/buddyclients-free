...
class ServiceStatusForm {
    ...
    public function form_fields( $values = null ) {
        ...
        $options = [
            ...
            'in_progress' => [
                'label' => __( 'In Progress', 'buddyclients-lite' ),
                'value' => 'in_progress',
            ],
            'complete' => [
                'label' => __( 'Complete', 'buddyclients-lite' ),
                'value' => 'complete',
            ],
            'cancellation_requested' => [
                'label' => __( 'Cancellation Requested', 'buddyclients-lite' ),
                'value' => 'cancellation_requested',
            ],
            'canceled' => [
                'label' => __( 'Canceled', 'buddyclients-lite' ),
                'value' => 'canceled',
            ],
        ];
